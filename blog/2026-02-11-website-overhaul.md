...
All blog posts are now part of the repo (in `/blog/`) instead of being stored separately outside the web directory. This means better version control and easier migrations.
